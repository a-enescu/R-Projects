...
#   Explore the geographical distribution of the restaurants and identify the
# cities with the maximum and minimum number of restaurants
#   Restaurant franchising is a thriving venture. So, it is very important to
...
# restaurant
#   Demonstrate the variables associated with each other and factors to build
# a dashboard
...
# We can observe in the above pie chart that 87.9% of restaurants don't have a table
# booking option
...
Cuisine <-
  select(RestDF1, Country, City, `Restaurant ID`, `Restaurant Name`, Cuisines)
...
wordcloud(
  ...
  main = "Top 10 cuisines in all the countries"
)
...
# The maximum number of cuisines served by a restaurant is 83: Cuisine is Cafe
# and the franchise name is Cafe Coffee Day
...
export(RestDF1, "RestDF1.xlsx")
export(Cuisine1, "Cuisine1.xlsx")
export(Top10_City, "Top10 City.xlsx")

### In order to have plot_ly work with PDR RMarkdown
