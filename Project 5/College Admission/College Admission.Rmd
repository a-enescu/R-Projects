...
3. Find the structure of the data set and if required, transform the numeric 
data type to factor and vice-versa.  
4. Find whether the data is normally distributed or not. Use the plot to 
determine the same.   
...
9. Try other modeling techniques like decision tree and SVM and select a 
champion model   
...
# Descriptive: 
13. Categorize the average of grade point into High, Medium, and Low (with 
...
Based on the Shapiro test (p-value is lower than 0.05) and the plots we can 
...
providing us with the right picture by giving us the correct, more unbiased and
real evaluation score of our model.  
